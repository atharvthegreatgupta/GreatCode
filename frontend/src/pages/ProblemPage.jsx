...
const ProblemPage = () => {
  ...
  return (
    <div className="h-screen flex p-4 gap-4 bg-gradient-to-br from-violet-200 via-fuchsia-100 to-cyan-200 font-sans overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar min-h-0 relative">
          {problem && (
            <>
              ...
              <div className={`animate-fadeIn ${activeLeftTab === 'editorial' ? 'block' : 'hidden'}`}>
              ...
              <div className={`animate-fadeIn ${activeLeftTab === 'solutions' ? 'block' : 'hidden'}`}>
              ...
              <div className={`animate-fadeIn ${activeLeftTab === 'submissions' ? 'block' : 'hidden'}`}>
              ...
              <div className={`animate-fadeIn ${activeLeftTab === 'chatAI' ? 'block' : 'hidden'}`}>
      ...
      {/* Right Panel */}
      <div className="w-1/2 flex flex-col bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/60 overflow-hidden relative">
